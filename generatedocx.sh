...
rm -f "output/docx/part${part}.docx"
...
#xfc_pro_java/bin/fo2docx "-genericFontFamilies=sans-serif=Arial Unicode MS" "output/fo/part${part}.fo" "output/docx/part${part}.docx"
xfc_pro_java/bin/fo2docx "-genericFontFamilies=sans-serif=Arial" "output/fo/part${part}.fo" "output/docx/part${part}.docx"
#xfc_pro_java/bin/fo2docx "output/fo/part${part}.fo" "output/docx/part${part}.docx"
