...
/* $Id: TTFReaderBBox.java,v 1.1 2015/07/01 15:31:42 dclunie Exp $ */
 ...
 */
public class TTFReaderBBox extends AbstractFontReader {
     ...
     * Main constructor.
     */
    public TTFReaderBBox() {
        super();
    }

    private static void displayUsage() {
        System.out.println(
                "java " + TTFReaderBBox.class.getName() + " [options] fontfile.ttf xmlfile.xml");
        System.out.println();
